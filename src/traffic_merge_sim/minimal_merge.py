...
RESULT_FIELDS = [
    "main_veh_h", "side_veh_h", "generated_veh", "arrived_veh", "unfinished_vehicles",
...
def run_load_sweep(
    ...
    *, seed: int | None = None, csv_path: Path | None = None,
) -> Path:
    ...
    rows = [
        run_single_case(main_rate, side_rate, end_time=end_time, seed=seed)
